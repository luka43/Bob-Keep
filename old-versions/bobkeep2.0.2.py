...
class LoginWindow(tkinter.Tk):
    ...
    def __init__(self):
        ...
        # Set Window
        #self.iconphoto(False, tkinter.PhotoImage(file="icon.ico"))
        self.iconphoto(False, tkinter.PhotoImage(file=self.resource_path("icon.ico")))
        self.geometry("400x120")
        self.eval("tk::PlaceWindow . center")
        self.title("BOB Keeper - Login")
    ...
    def tryLogin(self, *args):
        ...
        x01 = "0x0bbcf80bf633d612763b178703ad4b129d37f8ea2f11017d57c6ed14870992ee"
        #admin0000
        x02 = "0x53d6316bd7b9044e6bb5deaa87fe8316c2fde3938b78f8448875b08e551ccc95"
        log.write(f"Login attempt.[{args}]")
        password = self.passwordEntry.get()

        if hashlib.sha256(password.encode('utf-8')).hexdigest() == x01[2:]:
            log.write("Password correct! ")
            x = 1
            self.destroy()

        elif hashlib.sha256(password.encode('utf-8')).hexdigest() == x02[2:]:
            log.write("Password correct! ")
            x = 2
            self.destroy()
...
class MainWindow(tkinter.Tk):
    ...
    def __init__(self):
        ...
        # ------------------------------------------------- Set Main Window ------------------------------------------------- #
        self.iconphoto(False, tkinter.PhotoImage(file=self.resource_path("icon.ico")))
        self.geometry("650x700+10+10")
        self.title("Bar Owers Book Keeper  v2.0.1")
        self.resizable(False, False)
        ...
        self.editmenu.add_command(label="Add Items")
        self.editmenu.add_command(label="Delete Items")
        ...
        # TEXTBOX - List
        self.listTextBox = ScrolledText(self, font=('Arial', 11))
        ...
        # TEXTBOX - Log
        self.logTextBox = ScrolledText(self, font=('Arial', 10), height=0.5)
        ...
        separator_bot2.pack(fill="x", pady=5)
...
if x == 1 or x == 2:
    log.write(f"Login successful. Logged as: {x}")
    MainWindow().mainloop()
